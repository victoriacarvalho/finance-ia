...
-- CreateEnum
CREATE TYPE "TransactionCategory" AS ENUM ('LIGHT', 'WATER', 'INTERNET', 'CONDOMINIUM', 'RENT', 'HOME_MAINTENANCE', 'TRANSPORTATION', 'FOOD', 'MARKET', 'ENTERTAINMENT', 'HEALTH', 'SALARY', 'EDUCATION', 'OTHER', 'TRIP');
